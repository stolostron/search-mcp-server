	...
	return []ToolDefinition{
		{
			...
			Options: []mcp.ToolOption{
				// Basic filters
				mcp.WithString("kind",
					mcp.Description("Resource kind or comma-separated list. Examples: \"Pod\", \"Pod,ConfigMap,Service\", \"ManagedCluster\""),
				),
				mcp.WithString("name",
			...
			JSONSchema: map[string]interface{}{
				...
				"properties": map[string]interface{}{
					...
					"kind": map[string]interface{}{
						"type":        "string",
						"description": "Resource kind or comma-separated list. Examples: \"Pod\", \"Pod,ConfigMap,Service\", \"ManagedCluster\"",
					},
		...
		},
		{
			...
			Options: []mcp.ToolOption{
				...
				mcp.WithString("relatedKinds",
					mcp.Description("Comma-separated list of kinds to filter related results. Example: \"Pod,ReplicaSet\""),
				),
				mcp.WithInteger("maxHops",
				...
				mcp.WithInteger("limit",
					mcp.Description("Max total results (default 200, max 1000)"),
			...
			JSONSchema: map[string]interface{}{
				...
				"properties": map[string]interface{}{
					...
					"relatedKinds": map[string]interface{}{
						"type":        "string",
						"description": "Comma-separated list of kinds to filter related results. Example: \"Pod,ReplicaSet\"",
					},
					"maxHops": map[string]interface{}{
						"type":        "integer",
					...
					"outputMode": map[string]interface{}{
						"type":        "string",
						"enum":        []string{"list", "count"},
						"description": "Output format: list=full resource data, count=kind counts only",
						"default":     "list",
					},
					"limit": map[string]interface{}{
						"type":        "integer",
						"description": "Max total results (default 200, max 1000)",
						"default":     200,
						"minimum":     1,
						"maximum":     1000,
					},
